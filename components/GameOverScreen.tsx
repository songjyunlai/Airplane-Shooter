...
const GameOverScreen: React.FC<GameOverScreenProps> = ({ score, score2, onRestart, onMenu, xpEarned, levelUpInfo }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-red-900/50 p-10 rounded-lg shadow-2xl border border-red-500/50 text-center">
      ...
      {isMultiplayer ? (
       ...
       <div className="text-xl text-white my-4">
        ...
        {levelUpInfo && (
            <p className="mt-2 text-2xl font-bold text-green-400 animate-pulse">
